# -*- coding: utf-8 -*-
"""
𝐓𝐈𝐓𝐀𝐍 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐁𝐎𝐓 𝐕𝟑.𝟓 — FULL COLOR BUTTONS + ALL FIXES
...
CREDITS: TITAN CODER + OMEGA UPGRADE
"""
...
@app.route('/')
def home():
    return "I'm TITAN HOSTING BOT V3.5"
...
ADMIN_ID = 8794321786
YOUR_USERNAME = '@g0zom'
UPDATE_CHANNEL = 'https://t.me/aurexkeng'
UPDATE_GROUP = 'https://t.me/floatedchatss'

FORCE_SUB_CHANNELS = ["@aurexkeng"]
FORCE_SUB_CHANNEL_LINKS = [
    "https://t.me/aurexkeng"
]
FORCE_SUB_CHANNEL_NAMES = ["𝐀ᴜʀᴇx Kᴇɴɢ 👑"]

BASE_DIR = os.path.abspath(os.path.dirname(__file__))
UPLOAD_BOTS_DIR = os.path.join(BASE_DIR, 'TITAN_uploads')
TITAN_DATA_DIR = os.path.join(BASE_DIR, 'TITAN_data')
DATABASE_PATH = os.path.join(TITAN_DATA_DIR, 'TITAN_bot.db')
...
class ReferralSystem:
    ...
    def generate_referral_code(self, user_id):
        code = f"TITAN{user_id}{random.randint(1000, 9999)}"
...
def command_send_welcome(message):
    ...
    if referral_code and referral_code.startswith('TITAN'):
        try:
    ...
    try:
        ...
        try:
            response = requests.get(raw_url, timeout=30, headers={
                'User-Agent': 'Mozilla/5.0 (compatible; TITANBot/3.5)'
            })
        except Exception as e:
        ...
        while True:
            try:
                ...
                if '409' in str(e) or 'Conflict' in str(e):
                    ...
                    print("   Stop the other TITAN process/device before starting this one.")
